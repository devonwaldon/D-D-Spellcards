...
<html>
  ...
  <svg id="spell-card"
    ...
    <g id="spell-details"
      ...
      <foreignObject id="spell_range"
        width="159"
        height="0"
        x="43"
        y="<?php echo $detail_top; $detail_top+=18; ?>">
      ...
      <foreignObject id="spell_cast-time"
        width="159"
        height="0"
        x="43"
        y="<?php echo $detail_top; $detail_top+=18; ?>">
      ...
      <foreignObject id="spell_duration"
        width="159"
        height="0"
        x="43"
        y="<?php echo $detail_top; $detail_top+=18; ?>">
      ...
      <foreignObject id="spell_requirements"
        width="159"
        height="0"
        x="43"
        y="<?php echo $detail_top; $detail_top+=18; ?>">
  ...
  <form action="">
    ...
    <select type="text" id="card_class" name="card_class" value="<?php echo $card_class; ?>">
      <?php //if (!isset($card_class_options)){
          $card_class_options = array('generic','bard','paladin','druid','ranger','cleric','sorcerer','warlock','wizard');
          //} ?>
